	...
	private function _soap($platform){
		switch(strtolower($platform)){
			...
			case 'analysis':
				...
				break;
			default:
				$this->Soap_Client = $GLOBALS['config']['DES']['Soap_Client_tPlus'];
				$this->Soap_Header = $GLOBALS['config']['DES']['Soap_Header_tPlus'];
				break;
		}
	}
	/**
...
// 		exit;
	 ...
	 * 取表信息
	 */
	public function SelectTableInfo($platform, $tableName, $condition='', $order='', $isarray=true){
		$this->_soap($platform);
